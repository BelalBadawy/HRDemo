...
### Changed
- Configured the `ResultStatus` enum using the `[JsonConverter(typeof(JsonStringEnumConverter))]` attribute, enabling string-based serialization/deserialization for API response envelopes.
